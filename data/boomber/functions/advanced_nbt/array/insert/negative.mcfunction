scoreboard players add #bb.nbt.length bb.calculation 1
...
execute as @s[scores={bb.success=0}] if score #bb.nbt.index bb.calculation < #bb.nbt.length bb.calculation run function boomber:advanced_nbt/array/insert/insert
