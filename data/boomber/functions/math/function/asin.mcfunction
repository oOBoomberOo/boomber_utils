...
execute if score #bb.math.number bb.calculation matches 0..341 run function boomber:math/function/arcsine/1
execute if score #bb.math.number bb.calculation matches 342..642 run function boomber:math/function/arcsine/2
execute if score #bb.math.number bb.calculation matches 643..865 run function boomber:math/function/arcsine/3
execute if score #bb.math.number bb.calculation matches 866..984 run function boomber:math/function/arcsine/4
execute if score #bb.math.number bb.calculation matches 985..1000 run function boomber:math/function/arcsine/5
