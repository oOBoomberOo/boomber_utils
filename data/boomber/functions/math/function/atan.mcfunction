...
execute if score #bb.math.number bb.calculation matches 0..353 run function boomber:math/function/arctangent/1
execute if score #bb.math.number bb.calculation matches 354..823 run function boomber:math/function/arctangent/2
execute if score #bb.math.number bb.calculation matches 824..1697 run function boomber:math/function/arctangent/3
execute if score #bb.math.number bb.calculation matches 1698..5395 run function boomber:math/function/arctangent/4
execute if score #bb.math.number bb.calculation matches 5396..2147483647 run function boomber:math/function/arctangent/5
